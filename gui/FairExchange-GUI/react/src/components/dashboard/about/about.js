    ...
    return (
      <div className="page margin-left-0">
        <div className="page-content">
          ...
          <p className="font-weight-600 padding-bottom-20">{ translate('ABOUT.SAFEWALLET_NOTE') }</p>

          <div className="font-weight-600">{ translate('ABOUT.TESTERS') }</div>
          { translate('ABOUT.TESTERS_P1') } <a className="link" onClick={ () => this.openExternalWindow('https://safewallets.com/safecoin-wallets') }>{ translate('ABOUT.TESTERS_P2') }</a>.&nbsp;
          { translate('ABOUT.TESTERS_P3') } <a className="link" onClick={ () => this.openExternalWindow('https://discordapp.com/channels/412898016371015680/453204571393622027') }>#safewallet-wallet</a> Discord { translate('ABOUT.CHANNEL') }. <a className="link" onClick={ () => this.openExternalWindow('https://safewallets.com/discord') }>{ translate('ABOUT.GET_AN_INVITE') }</a> { translate('ABOUT.GET_AN_INVITE_P2') }.&nbsp;
          { translate('ABOUT.TESTERS_P4') }

          <div className="padding-top-20">{ translate('ABOUT.SAFEWALLET_DAPPS') }</div>
          <ul>
            <li>
