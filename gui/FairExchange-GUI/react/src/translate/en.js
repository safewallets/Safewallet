...
const LANG_EN = {
  ...
  IMPORT_KEY: {
    ...
    SAFE_Z_KEY_DEPRECATED: 'SAFE Z keys are not supported at the moment',
  },
  CLAIM_INTEREST: {
  ...
  SUPPORT: {
    ...
    TO_SEND_FEEDBACK_P2: 'or send an email to support@safewallets.com',
  },
  SETTINGS: {
  ...
  SEND: {
    ...
    SAFE_Z_ADDRESSES_DEPRECATED: 'SAFE Z addresses are not supported at the moment',
    SAFE_Z_ADDRESSES_DEPRECATED_NOTICE: 'Private transaction are being disabled as of 15th February 2019 on SAFE chain permanently.',
  ...
  TOOLS: {
    ...
    PROVIDE_SAFEWALLET_MULTISIG_DATA_HERE: 'Provide Safewallet generated multi signature data here',
    PROVIDE_SAFEWALLET_GENERATED_INCOMPLETE_MULTISIG_DATA_HERE: 'Provide Safewallet generated incomplete multi signature transaction data here',
    ...
    SAFEWALLET_MULTISIG_DATA: 'Safewallet multi signature data',
    ...
    USE_THE_FOLLOWING_INFO_TO_CREATE_MULTISIG_TX: 'Use the following info to create multi signature transactions in Safewallet',
    LOCKTIME: 'Locktime',
    MULTI: 'multi',
  ...
  EXCHANGES: {
    ...
    TOS_P1: 'If you continue you agee to use a 3rd party service Coinswitch.co. All your actions with the use of Coinswitch.co API are outside of Safecoin Platform control and are subject to Coinswitch.co',
    TOS_P2: 'terms of service',
    TOS_P3: 'Safecoin Platform will not disclose any private information to Coinswitch.co. All details that you may provide to Coinswitch.co will be subject to Coinswitch.co',
    TOS_P4: 'SAFECOIN PLATFORM ACCEPTS NO RESPONSIBILITY AND WILL NOT BE LIABLE FOR ANY LOSS OR DAMAGE WHATSOEVER SUFFERED AS A RESULT OF ACCESSING, USE OF, OR RELIANCE UPON COINSWITCH.CO INFORMATION AND SERVICES.',
